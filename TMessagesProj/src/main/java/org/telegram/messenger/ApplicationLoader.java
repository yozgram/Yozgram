...
import org.telegram.Adel.AccountUtil;
...
public class ApplicationLoader extends MultiDexApplication {
    ...
    private static void convertConfig() {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences(ApplicationLoader.instance_number + "dataconfig", Context.MODE_PRIVATE);
        if (preferences.contains("currentDatacenterId")) {
            ...
            try {
                File file = new File(getFilesDirFixed(), "tgnet_" + ApplicationLoader.instance_number + ".dat");
    ...
    public static void postInitApplication() {
        ...
        ConnectionsManager.getInstance().init(ApplicationLoader.instance_number, BuildVars.BUILD_VERSION, TLRPC.LAYER, BuildVars.APP_ID, deviceModel, systemVersion, appVersion, langCode, systemLangCode, configPath, FileLog.getNetworkLogPath(), UserConfig.getClientUserId(), enablePushConnection);
    ...
    public static void startPushService() {
        SharedPreferences preferences = applicationContext.getSharedPreferences(ApplicationLoader.instance_number + "Notifications", MODE_PRIVATE);
