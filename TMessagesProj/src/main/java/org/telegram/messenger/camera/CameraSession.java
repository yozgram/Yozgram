...
public class CameraSession {
    ...
    public CameraSession(CameraInfo info, Size preview, Size picture, int format) {
        ...
        SharedPreferences sharedPreferences = ApplicationLoader.applicationContext.getSharedPreferences(ApplicationLoader.instance_number + "camera", Activity.MODE_PRIVATE);
