...
public class StatsController {
    ...
    private StatsController() {
        SharedPreferences sharedPreferences = ApplicationLoader.applicationContext.getSharedPreferences(ApplicationLoader.instance_number + "stats", Context.MODE_PRIVATE);
        boolean save = false;
