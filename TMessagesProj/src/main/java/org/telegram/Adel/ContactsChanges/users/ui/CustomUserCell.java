package org.telegram.Adel.ContactsChanges.users.ui;
...
public class CustomUserCell extends FrameLayout {
    ...
    private int statusOnlineColor = 0xff3b84c0; // Adel Temp
    ...
    public CustomUserCell (Context context, int padding, int checkbox, boolean admin) {
        ...
        if (checkbox == 2) {
            checkBoxBig = new CheckBoxSquare(context, false); // Adel
    ...
    public void setIsAdmin(int value) {
        ...
        if (value == 1) {
            ...
            adminImage.setImageResource(R.drawable.ic_star_gray_24dp); // Adel Temp
        }
    }
...
//        avatarDrawable.setRadius(AndroidUtilities.dp(radius)); // Adel Temp
        //
