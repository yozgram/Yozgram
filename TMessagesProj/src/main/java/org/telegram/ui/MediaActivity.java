...
public class MediaActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public boolean onFragmentCreate() {
        ...
        mediaType = getArguments().getInt("mediaType", SharedMediaQuery.MEDIA_PHOTOVIDEO); // Adel
        ...
        SharedMediaQuery.loadMedia(dialog_id, 0, 50, 0, mediaType, true, classGuid); // Adel
        return true;
    }
