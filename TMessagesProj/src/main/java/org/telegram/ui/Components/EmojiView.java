...
public class EmojiView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void saveNewPage() {
        ...
        if (currentPage != newPage) {
            currentPage = newPage;
            getContext().getSharedPreferences(ApplicationLoader.instance_number + "emoji", Activity.MODE_PRIVATE).edit().putInt("selected_page", newPage).commit();
        }
    }

    public void clearRecentEmoji() {
        SharedPreferences preferences = getContext().getSharedPreferences(ApplicationLoader.instance_number + "emoji", Activity.MODE_PRIVATE);
